...
private:
	...
	static void printAllWords(RenderWindow & window, GameGround& gra) {
		Font font;
...
public:
	static void menu(RenderWindow & window, GameGround& gra) {
		...
		while (isMenu)
		{
			...
			if (IntRect(38, 453, 389, 158).contains(Mouse::getPosition(window))) { menu4.setTexture(menu4vib); menuNum = 4; }
